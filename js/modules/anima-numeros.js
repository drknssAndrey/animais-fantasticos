export default class initAnimaNumeros {
  ...
  // recebe um elemento do dom, com numero em seu texto e incrementa a partir de 0 até o número final
  ...
  // ativa incrementar numero para numero selecionado do dom
  animaNumeros() {
